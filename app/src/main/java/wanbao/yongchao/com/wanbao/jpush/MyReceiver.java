...
public class MyReceiver extends JPushMessageReceiver {
    ...
    public void onMultiActionClicked(Context context, Intent intent) {
        ...
        try{
            ...
            Intent i = new Intent(context, MainActivity.class);
//            Bundle bundle = new Bundle();
//            bundle.putString(JPushInterface.EXTRA_NOTIFICATION_TITLE,nActionExtra);
//            bundle.putString(JPushInterface.EXTRA_ALERT,message.notificationContent);
//            i.putExtras(bundle);
//            //i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//            i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP );
...
//        }
        ...
        receivingNotification(context,customMessage);
    }
...
//        Log.d(TAG, "extras : " + extras!!)
        notification(context, customMessage.message);
    }

    private void notification( Context mContext, String data) {
