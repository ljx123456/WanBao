...
import wanbao.yongchao.com.wanbao.ui.explore.mvp.presenter.WantUserPresenter
...
class WantActivity:BaseActivity(),WantUserView{
    override fun getWantUserRequest(data: WantUserBean) {
        ...
        adapter!!.setOnLoadMoreListener(object : BaseQuickAdapter.RequestLoadMoreListener{
            override fun onLoadMoreRequested() {
                ...
                presenter.getWantUser(WantUserBody(intent.getStringExtra("id"),pageIndex,pageSize))
            }
        },recy_want)
...
//            adapter!!.addFooterView(View.inflate(activity!!,R.layout.layout_community_footer,null))
    ...
    private val presenter by lazy { WantUserPresenter(this,this,this) }
