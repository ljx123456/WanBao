...
import wanbao.yongchao.com.wanbao.ui.news.adapter.NoticeAtAdapter
...
import wanbao.yongchao.com.wanbao.ui.news.mvp.presenter.NoticeAtPresenter
...
class NoticeAtActivity:BaseActivity(),NoticeAtView {
    override fun NoticeAtRequest(data: NoticeAtBean) {
        ...
        if (adapter!=null){
            ...
            adapter= NoticeAtAdapter(data.data)
            var manager= LinearLayoutManager(this)
            manager.orientation= LinearLayout.VERTICAL
            recy_notice.layoutManager=manager
            recy_notice.adapter=adapter
            adapter!!.setEmptyView(layoutUtils.getNoneNoticeAt())
        }
...
//            adapter!!.addFooterView(View.inflate(activity!!,R.layout.layout_community_footer,null))
    ...
    private val presenter by lazy { NoticeAtPresenter(this,this,this) }
    private var pageIndex=1
    private val pageSize=10

    private var adapter:NoticeAtAdapter?=null
    private var posi=0
