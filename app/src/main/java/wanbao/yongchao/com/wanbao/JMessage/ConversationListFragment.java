...
import wanbao.yongchao.com.wanbao.ui.main.fragment.NewsFragment;
...
//    private MenuItemController mMenuController;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRootView = layoutInflater.inflate(R.layout.fragment_conv_list,
                (ViewGroup) getActivity().findViewById(wanbao.yongchao.com.wanbao.R.id.main), false);
        mConvListView = new ConversationListView(mRootView, this.getActivity(), this,TagUtil.INSTANCE.getTag());
...
//        ((NewsFragment)getParentFragment()).
...
//    }
    ...
    public void setNotice(String content,String time,String num){
        if (mConvListView!=null) {
            mConvListView.showNoticHeaderView(content,time,num);
        }
    }
    ...
    public void delSystem(){
        ((NewsFragment)getParentFragment()).delSystem();
