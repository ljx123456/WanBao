package wanbao.yongchao.com.wanbao.ui.mine.utils;
...
import wanbao.yongchao.com.wanbao.ui.main.utils.banner.ConvenientBanner;
...
//                                    imagelist.add(new ImageBannerInfo(imageInfo.getImageUrl(), imageInfo.isAddButton(), imageInfo.getImageId(),imageInfo.getUrl(),imageInfo.getTitle(),imageInfo.getDescription()));
                                    images.add(imageInfo.getImageUrl());
                                }
                            });
                            intentUtils.INSTANCE.intentEditBusinessCover(images);
                        }
