package wanbao.yongchao.com.wanbao.view.NineGrid;
...
public abstract class NineGridLayout extends ViewGroup {
    ...
    private void refresh() {
        ...
        if (size == 1) {
            String url = mUrlList.get(0)+"?imageView2/1/w/200/h/200/q/75";
        ...
        for (int i = 0; i < size; i++) {
            String url = mUrlList.get(i)+"?imageView2/1/w/200/h/200/q/75";
    ...
    private RatioImageView createImageView(final int i, final String url) {
        ...
        imageView.setCornerRadius(dip2px(mContext,4));
