...
class LikeCommunityActivity:BaseActivity(),ShareDialog.Share ,LikeCommunityView{
...
//        manage.setmCanVerticalScroll(false)
                recy_like.layoutManager = manage
                recy_like.adapter = adapter
...
//        Toast.Tips("分享到QQ")
    ...
    override fun getActivityLayout(): Int = R.layout.activity_like
