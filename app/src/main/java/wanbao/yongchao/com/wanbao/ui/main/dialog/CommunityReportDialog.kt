...
class CommunityReportDialog(val id:String) : BaseDialogFragment() {
    ...
    override fun setLayoutData() {
        dialog= CommunityReportDetailsDialog(id,"1")
    }
    ...
    override fun clickListener() {
        ...
        Click.viewClick(tv_report8).subscribe {
            dismiss()
            dialog.setReportID(8)
            dialog.show(activity!!.supportFragmentManager,"")
        }
