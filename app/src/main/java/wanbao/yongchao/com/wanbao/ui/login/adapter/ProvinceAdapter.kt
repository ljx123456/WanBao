...
class ProvinceAdapter(list: MutableList<AreaBean.DataBean>):BaseQuickAdapter<AreaBean.DataBean,BaseViewHolder>(R.layout.item_business_area,list){
...
//            adapter.data[position].flag=true
            ...
            callBack!!.chooseProvince(adapter.data[position].name,adapter.data[position].id)
        }
    }
    ...
    interface CallBack{
        fun chooseProvince(str:String,id:Int)
    }
