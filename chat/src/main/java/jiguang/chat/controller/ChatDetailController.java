...
public class ChatDetailController implements OnClickListener, OnItemClickListener,
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R2.id.group_chat_del_ll:
                ...
                break;
            //删除好友或群组
            case R2.id.chat_detail_del_group:
            ...
            case R2.id.tv_moreGroup:
                ...
                break;
            case R2.id.chat_detail_add_friend:
    ...
    public void onChanged(int id, final boolean checked) {
        switch (id) {
            case R2.id.no_disturb_slip_btn:
