 ...
 * 二维码扫描使用
 */
public final class CommonScanActivity extends Activity {
...
//
//    @Bind(R2.id.scan_image)
//    ImageView scan_image;
//    @Bind(R2.id.authorize_return)
//    ImageView authorize_return;
//    private int scanMode;//扫描模型（二维码）
//
//    @Bind(R2.id.common_title_TV_center)
//    TextView title;
//    @Bind(R2.id.scan_hint)
//    TextView scan_hint;
//    @Bind(R2.id.tv_scan_result)
...
//                break;
//            case R2.id.qrcode_g_gallery:
//                showPictures(PHOTOREQUESTCODE);
//                break;
//            case R2.id.authorize_return:
//                finish();
//                break;
//            default:
//                break;
