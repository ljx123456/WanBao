...
public class HistoryFileController implements View.OnClickListener, ViewPager.OnPageChangeListener,
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R2.id.actionbar_album_btn:
                mSFView.setCurrentItem(0);
                break;
            case R2.id.actionbar_file_btn:
                mSFView.setCurrentItem(1);
                break;
            case R2.id.actionbar_video_btn:
                mSFView.setCurrentItem(2);
                break;
            case R2.id.actionbar_audio_btn:
                mSFView.setCurrentItem(3);
                break;
            case R2.id.actionbar_other_btn:
                mSFView.setCurrentItem(4);
                break;
            case R2.id.return_btn:
                mContext.finish();
                break;
            case R2.id.delete_file_btn:
                if (idMap.size() == 0) {
                    break;
                }
                if (isGroup) {
